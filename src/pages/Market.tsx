...
import banner from '../images/market.png';
...
export default function Market() {
  ...
  const [filterRaffles, setFilterRaffles] = useState<boolean>(false);
  const [filterMerch, setFilterMerch] = useState<boolean>(false);
